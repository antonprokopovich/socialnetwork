...
// to (to hold the form data) and an Errors field to hold any validation errors
// for the form data
type Form struct {
	url.Values
	Errors formErrors
...
// If any fields fail this check, add the appropriate message to the Errors.
...
// If the check fails then it adds the appropriate message to Errors.
...
// then add the appropriate message the Errors.
...
// Valid method checks Errors for any present errors. It returns true if there are no errors,
